<?php
/**
 * Queer Times — LinkedIn Category Archive
 *
 * Displays all articles tagged 'linkedin' in a vintage newspaper layout.
 * These articles live on the website first and are cross-posted to
 * LinkedIn 48 hours after publication.
 */
    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
                ...
                <?php while ( have_posts() ) : the_post(); ?>
                    ...
                    <article <?php post_class( 'pt-8 first:pt-0' ); ?>>
                        ...
                        <p class="text-xs tracking-widest uppercase text-[#8b7355] mb-3 font-serif">
                            ...
                            // Show "Also on LinkedIn" badge once 48hrs have passed
                            $pub_ts = get_the_date( 'U' );
                            if ( $pub_ts && ( time() - (int) $pub_ts ) >= ( 48 * HOUR_IN_SECONDS ) ) :
                            ?>
                                <span class="ml-3 inline-flex items-center gap-1 text-[#8b7355]">
                                    <svg class="w-3 h-3 fill-current" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                                    <?php _e( 'Also on LinkedIn', 'queer-times' ); ?>
                                </span>
                            <?php endif; ?>
                        </p>
        ...
        <?php else : ?>
            <p class="font-serif text-sm italic">
                <?php _e( 'No LinkedIn articles yet. The first dispatch is being written.', 'queer-times' ); ?>
            </p>
        <?php endif; ?>
