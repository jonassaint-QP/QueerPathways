...
const CATALOGUE: { category: string; tagline: string; products: Product[] }[] = [
  ...
  },
  {
    ...
    products: [
      ...
      {
        id: 'ultimate-obedience-chair',
        name: 'Ultimate Obedience Chair | Bondage Throne with Sex Machine',
        icon: <Crosshair className="text-amber-400" size={22} />,
        images: ["/Images/somatic-toolkit/ah155-1.jpg", "/Images/somatic-toolkit/ah155-2.jpg", "/Images/somatic-toolkit/ah155-3.jpg", "/Images/somatic-toolkit/ah155-4.jpg", "/Images/somatic-toolkit/ah155-5.jpg", "/Images/somatic-toolkit/ah155-6.jpg", "/Images/somatic-toolkit/ah155-7.jpg"],
        description: 'A heavy-duty adjustable throne built on a wood and iron frame rated for 440 pounds, with plush PVC leather padding. The backboard moves from upright to fully reclined, the leg rests adjust to whatever height exposes you best, and the integrated detachable sex machine delivers 195 thrusts per minute through a corded handheld controller. Six quick-release nylon straps with ABS plastic buckles secure your chest, waist, and legs. D-rings on the side frame accept wrist cuffs and extra hardware. Gear, Not Medicine: This item is intended for personal somatic exploration and sensory scaffolding, not medical or therapeutic treatment.',
        tag: 'Positional Scaffolding',
        priceUsd: 125000,
      },
      {
        id: 'st-andrews-cross-deluxe',
        name: 'St. Andrew\'s Cross Deluxe | Free-Standing Restraint Frame',
        icon: <Crosshair className="text-amber-400" size={22} />,
        images: ["/Images/somatic-toolkit/AH354-1.jpg", "/Images/somatic-toolkit/AH354-2.jpg", "/Images/somatic-toolkit/AH354-3.jpg", "/Images/somatic-toolkit/AH354-4.jpg", "/Images/somatic-toolkit/AH354-5.jpg", "/Images/somatic-toolkit/AH354-6.jpg", "/Images/somatic-toolkit/AH354-7.jpg", "/Images/somatic-toolkit/AH354-8.jpg"],
        description: 'The architectural centerpiece of any room that has decided to stop pretending. This free-standing iron and wood frame stands 72 inches tall and 43.5 inches wide, with foam padding wrapped in vegan leather. The cross adjusts to three angles—70, 75, and 80 degrees—so you can match the lean to the height and flexibility of whoever is being restrained. Four attachment points accept ankle and wrist cuffs, keeping the subject open and available for impact or sensation play. Gear, Not Medicine: This item is intended for personal somatic exploration and sensory scaffolding, not medical or therapeutic treatment.',
        tag: 'Architectural Restraint',
        priceUsd: 68000,
      },
      {
        id: 'bareback-submission-horse',
        name: 'Bareback Submission Horse | Bondage Bench',
        icon: <Crosshair className="text-amber-400" size={22} />,
        images: ["/Images/somatic-toolkit/AH158-1.jpg", "/Images/somatic-toolkit/AH158-2.jpg"],
        description: 'A bondage bench built for exposure, access, and endurance. The subject kneels or straddles the padded saddle while knee supports hold them open and six attachment points accept cuffs at ankles, wrists, and waist. Rated for 660 pounds with smooth vegan leather padding. Gear, Not Medicine: This item is intended for personal somatic exploration and sensory scaffolding, not medical or therapeutic treatment.',
        tag: 'Positional Scaffolding',
        priceUsd: 52000,
      },
      {
  ...
  },
  {
    ...
    products: [
      ...
      {
        id: 'power-up-automatic-pump',
        name: 'Power Up Rechargeable Automatic Penis Pump',
        icon: <Zap className="text-amber-400" size={22} />,
        images: ["/Images/somatic-toolkit/CN1036-1.jpg", "/Images/somatic-toolkit/CN1036-2.jpg", "/Images/somatic-toolkit/CN1036-3.jpg", "/Images/somatic-toolkit/CN1036-4.jpg", "/Images/somatic-toolkit/CN1036-5.jpg", "/Images/somatic-toolkit/CN1036-6.jpg"],
        description: 'A rechargeable automatic pump delivering three speeds of graduated suction through a clear medical-grade SAN plastic cylinder. The silicone sleeve creates an airtight seal without latex, and an external mechanical dump valve releases pressure instantly when needed. Gear, Not Medicine: This item is intended for personal somatic exploration and sensory scaffolding, not medical or therapeutic treatment.',
        tag: 'Precision Mechanical',
        priceUsd: 11000,
      },
      {
