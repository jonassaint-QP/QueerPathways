  ...
  return (
    <div className="space-y-16 py-6">
      ...
      <section className="relative bg-obsidian-card border border-obsidian-border rounded-2xl p-8 md:p-12 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-somatic-skin/10 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-text-primary tracking-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-somatic-warmth to-somatic-skin">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-text-primary pt-2">
            ...
            <span className="border border-somatic-warmth/30 bg-somatic-warmth/10 text-somatic-warmth px-3 py-1.5 rounded-md">
      ...
      <section className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-obsidian-border pb-4 gap-2">
          <div>
            <span className="font-mono text-xs text-somatic-skin tracking-widest uppercase">Fee Schedule</span>
            <h2 className="font-display text-2xl sm:text-3xl font-bold text-text-primary mt-1">
              Dignity Investment Protocol
            </h2>
          </div>
          <div className="text-xs font-mono text-somatic-warmth bg-obsidian-card border border-somatic-warmth/30 px-3 py-1.5 rounded-md">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-obsidian-card border border-obsidian-border rounded-xl p-6 flex flex-col justify-between hover:border-somatic-warmth/50 transition-all group relative overflow-hidden">
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-mono text-xs text-somatic-warmth">01 / FIRST BOUNDARY</span>
            ...
            <a 
              href="#intake-portal"
              className="mt-6 w-full py-2.5 bg-somatic-warmth/10 border border-somatic-warmth text-somatic-warmth hover:bg-somatic-warmth hover:text-obsidian-deep text-center font-mono text-xs font-bold uppercase tracking-wider rounded transition-all"
            >
              Book Intake
            </a>
          </div>
          ...
          <div className="bg-obsidian-card border border-somatic-warmth/40 rounded-xl p-6 flex flex-col justify-between hover:border-somatic-warmth transition-all group relative overflow-hidden shadow-[0_0_20px_rgba(163, 177, 138,0.05)]">
            <div className="absolute top-0 right-0 bg-somatic-warmth text-obsidian-deep font-mono text-[10px] font-bold px-3 py-1 rounded-bl-lg uppercase">
              Core Practice
            </div>
            
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-mono text-xs text-somatic-warmth">02 / INDIVIDUAL</span>
            ...
            <a 
              href="#intake-portal"
              className="mt-6 w-full py-2.5 bg-somatic-warmth text-obsidian-deep font-mono text-xs font-bold uppercase tracking-wider rounded hover:opacity-90 transition-all text-center"
            >
              Select Individual
            </a>
          </div>
          ...
          <div className="bg-obsidian-card border border-obsidian-border rounded-xl p-6 flex flex-col justify-between hover:border-somatic-skin/50 transition-all group relative overflow-hidden">
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-mono text-xs text-somatic-skin">03 / RELATIONAL</span>
                <span className="text-xs font-mono text-text-secondary">50 MIN</span>
              </div>
            ...
            <a 
              href="#intake-portal"
              className="mt-6 w-full py-2.5 bg-somatic-skin/10 border border-somatic-skin text-somatic-skin hover:bg-somatic-skin hover:text-obsidian-deep text-center font-mono text-xs font-bold uppercase tracking-wider rounded transition-all"
            >
              Book Relational
            </a>
          </div>
          ...
          <div className="space-y-3 bg-obsidian-deep border border-obsidian-border p-5 rounded-lg">
            ...
            <div className="pt-2">
              <a 
                ...
                className="inline-flex items-center space-x-2 text-somatic-warmth hover:underline"
              >
